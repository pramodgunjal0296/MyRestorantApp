      ...
      items-start justify-center gap-6">
        ...
        font-bold tracking-wide text-headingColor'>
           ...
           md:text-left md:w-[80%]'>
                    ...
                    Pariatur ullam, odit esse sapiente libero harum doloremque neque nostrum numquam, inventore soluta vel culpa!
                    Laudantium velit perferendis optio voluptates nihil accusantium.
                </p>
          ...
          md:w-auto
          to-orange-500 w-full px-4 py-2 rounded-lg 
...
<div key={n.id}  className=" lg:w-190 p-4 bg-cardOverlay 
         ...
         flex mt-8 items-center flex-col flex-wrap
         drop-shadow-lg ">
                                <img src={n.imageSrc}
