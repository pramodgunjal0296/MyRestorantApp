  ...
  return (
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className='hidden md:flex w-full h-full items-center justify-between '>
        ...
        <div className="flex items-center gap-8">
          <motion.ul
            ...
            hover:text-headnigColor duation-100
        ...
        top-12 right-0'>
                  {
                    user && user.email === "pramodgunjal1996@gmail.com" && (
                      <Link to={"/createItem"}>
         ...
         onClick={()=>setIsMenu(false)}>
                  ...
                  <p className='m-2 p-2 rounded-md shadow-md flex items-center gap-3 cursor-pointer hover:bg-slate-100 
         transition-all duration-100 ease-in-out text-textColor text-base'
                    onClick={logout}
                  >Logout <MdLogout /></p>
                </motion.div>
      ...
      <div className='flex items-center justify-between md:hidden w-full h-full'>
        <div className='relative flex items-center justify-center'>
          <MdShoppingBasket className='text text-textColor text-2xl
           ml-8 cursor-pointer' />
        ...
        top-12 right-0'>
          ...
          transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2'>Service</li>
                ...
                <p className='m-2 p-2 rounded-md shadow-md flex items-center gap-3 bg-gray-200 cursor-pointer hover:bg-gray-300 
         transition-all duration-100 ease-in-out text-textColor text-base'
                  onClick={logout}
                >Logout <MdLogout /></p>
              </motion.div>
